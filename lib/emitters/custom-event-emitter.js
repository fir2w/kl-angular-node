...
var util = require("util")
  , factEventEmitter = require("events").EventEmitter
  , Promise = require("bluebird")
  , proxyEventKeys = ['success', 'error']

  , Utils = require('../util/tools');
...
module.exports = (function () {
  var ServiceCustomEventEmitter = function (fct) {
    this.fct = bindToProcess(fct);
  };
  util.inherits(ServiceCustomEventEmitter, factEventEmitter);

  ServiceCustomEventEmitter.prototype.run = function () {
    Utils.tick(function () {
      if (this.fct) {
  ...
  ServiceCustomEventEmitter.prototype.emit = function (type) {
    ...
    factEventEmitter.prototype.emit.apply(this, arguments);
  };
   ...
   */
  ServiceCustomEventEmitter.prototype.success =
    ServiceCustomEventEmitter.prototype.ok =
      function (fct) {
  ...
  /**
   ...
   The function returns the instance of the query.
   */
  ServiceCustomEventEmitter.prototype.failure =
    ServiceCustomEventEmitter.prototype.fail =
      ServiceCustomEventEmitter.prototype.error =
        function (fct) {
          this.on('error', bindToProcess(fct));
          return this;
        };

  ServiceCustomEventEmitter.prototype.done =
    ServiceCustomEventEmitter.prototype.complete =
      function (fct) {
  ...
  ServiceCustomEventEmitter.prototype.sql = function (fct) {
   ...
   *
   * @param  {ServiceCustomEventEmitter} emitter The event emitter that should receive the events.
   * @return {void}
   */
  ServiceCustomEventEmitter.prototype.proxy = function (emitter, options) {
  ...
  ServiceCustomEventEmitter.prototype.then = function (onFulfilled, onRejected) {
    var self = this;
  ...
  ServiceCustomEventEmitter.prototype.spread = function (onFulfilled, onRejected) {
    var self = this;
  ...
  return ServiceCustomEventEmitter;
})();
